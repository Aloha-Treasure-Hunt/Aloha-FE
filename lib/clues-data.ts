import { ClueData } from '@/components/clues/clue'
...
export const cluesData: ClueData[] = [
  ...
  {
    title: "Clue 3",
    description: "Seek a place that embodies the spirit of compassion, offering support to those who need it most.",
    hint: "Located on Nguyễn Công Trứ Street, the building acts as a sanctuary for those who we all once were"
  },
  {
    title: "Clue 4",
  ...
  {
    title: "Clue 6",
    description: "Where the guardian of the sea stands tall, beneath her watchful gaze, gather your crew by the shore where the night whispers secrets of the waves.",
    hint: "Where the waves kiss the shore and the Lady watches over"
  }
] as const 