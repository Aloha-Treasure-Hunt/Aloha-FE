              ...
              >
                <div className="bg-white rounded-lg p-3 mb-3 border border-amber-100 text-left text-sm text-gray-700">
                  <div className="flex items-start mb-1">
                    <div className="min-w-5 h-5 rounded-full bg-amber-100 flex items-center justify-center text-amber-600 text-xs mr-2">
                      1
                    </div>
                    <div>
          ...
          >
            ...
            {errorInfo?.data.currentProgress && (
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <motion.div
                  initial={{ width: 0 }}
                  animate={{ width: `${errorInfo.data.currentProgress}%` }}
