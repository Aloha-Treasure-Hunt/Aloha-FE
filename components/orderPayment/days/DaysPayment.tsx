  ...
  return (
    <div className="bg-gradient-to-b from-teal-600 to-teal-700 min-h-screen font-sans">
      ...
      <div className="text-white px-4 sm:px-6 mb-6">
        <h2 className="text-xl font-bold mb-2">Fifteen Days Package</h2>
        <div className="flex items-center">
        ...
        <div className="p-5">
          <div className="bg-pink-50 rounded-xl p-4 mb-6 border-2 border-teal-600">
            <div className="flex justify-between items-center mb-2">
              <div>
                <span className="text-gray-800 font-bold text-lg">15 Days Plan</span>
                <div className="text-green-600 text-xs font-medium mt-1">Save 20%</div>
              </div>
              <div className="text-right">
                <span className="text-teal-600 font-bold text-xl">US$3/mo</span>
            ...
            <div className="mt-3 pt-3 border-t border-gray-200">
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="text-gray-800 font-medium">US$2/mo</span>
              </div>
              <div className="flex justify-between text-sm mb-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-800 font-medium">US$3/mo</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex items-center">
                <div className="flex flex-col items-center mr-3">
                  ...
                  <div className="h-14 w-1 bg-red-400"></div>
                </div>
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <CreditCard size={18} className="mr-2 text-gray-700" />
                      <span className="text-red-600 font-bold">FROM NOW</span>
                    </div>
                    <div className="text-right">
                      <span className="text-gray-800 font-bold">US$3/mo</span>
                      <div className="text-gray-500 text-xs">incl. VAT</div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex items-center">
                ...
                <div className="flex-1">
                  <span className="text-teal-600 font-bold">To March 23, 2025</span>
                </div>
              </div>
            </div>
          </div>
