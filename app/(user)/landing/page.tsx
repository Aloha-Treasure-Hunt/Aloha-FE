...
export const metadata = {
  ...
  description:
    'Explore the city, solve clues, complete challenges, and win prizes in this exciting five-day treasure hunt adventure!',
};
      ...
      <div className='py-20 space-y-16'>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          <section className='card p-8'>
            <h2 className='heading-medium mb-6'>How to Play</h2>
            <div className='prose'>
              <ol className='list-decimal list-inside space-y-4'>
                <li>
                  Join the{' '}
                  <a
                    href='https://chat.whatsapp.com/Gzff8wsNHlqERDmtD8Bck4'
                    className='text-amber-700 hover:underline font-bold uppercase'
                  >
                    WHATSAPP GROUP
                  </a>{' '}
                  to join the hunt!
          ...
          <section className='card p-8'>
            <h2 className='heading-medium mb-6'>Hunt Area</h2>
            <MapComponent />
          </section>
        </div>
